        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "radio"
                    label _("Typeface")
                    textbutton _("rainyhearts") action [gui.SetPreference("font", "gui/font/rainyhearts.ttf"), gui.SetPreference("size", 38), SetVariable("persistent.typeface", "rainyhearts")] alt "Change font to rainyhearts"
                ...
                vbox:
                    ...
                    elif persistent.typeface == "rainyhearts":
                        textbutton _("Large") action gui.SetPreference("size", 45) alt "Change to Large Size Text"
                        textbutton _("Regular") action gui.SetPreference("size", 38) alt "Change to Regular Size Text"
